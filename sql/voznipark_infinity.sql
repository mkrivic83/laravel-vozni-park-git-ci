...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2026 at 08:33 PM
...
('zwVS2ozZHr2pCdLS5Cma24a6IIXPrhuxvEYcTGFK', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36', '', 1770054630);
...
--
-- Indexes for table `namjena_vozila`
--
ALTER TABLE `namjena_vozila`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `vozilo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vozilo_namjenaid_foreign` (`namjenaid`);
...
--
-- AUTO_INCREMENT for table `namjena_vozila`
--
ALTER TABLE `namjena_vozila`
